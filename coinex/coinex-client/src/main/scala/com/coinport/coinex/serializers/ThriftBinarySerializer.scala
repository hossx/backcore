...
class ThriftBinarySerializer extends Serializer {
  ...
  lazy val _cBankCard = BinaryScalaCodec(BankCard)
  ...
  lazy val _cAddBankCardFailed = BinaryScalaCodec(AddBankCardFailed)
  lazy val _cAddBankCardSucceeded = BinaryScalaCodec(AddBankCardSucceeded)
  ...
  lazy val _cCanHotColdInterTransfer = BinaryScalaCodec(CanHotColdInterTransfer)
  lazy val _cCanHotColdInterTransferResult = BinaryScalaCodec(CanHotColdInterTransferResult)
  lazy val _cCancelOrderFailed = BinaryScalaCodec(CancelOrderFailed)
  lazy val _cCleanBitwayData = BinaryScalaCodec(CleanBitwayData)
  lazy val _cCleanBlockChain = BinaryScalaCodec(CleanBlockChain)
  lazy val _cCleanUserData = BinaryScalaCodec(CleanUserData)
  ...
  lazy val _cDeleteBankCardFailed = BinaryScalaCodec(DeleteBankCardFailed)
  lazy val _cDeleteBankCardSucceeded = BinaryScalaCodec(DeleteBankCardSucceeded)
  lazy val _cDoAddBankCard = BinaryScalaCodec(DoAddBankCard)
  lazy val _cDoAddNewApiSecret = BinaryScalaCodec(DoAddNewApiSecret)
  lazy val _cDoAddRobotDNA = BinaryScalaCodec(DoAddRobotDNA)
  lazy val _cDoBindMobile = BinaryScalaCodec(DoBindMobile)
  lazy val _cDoBindMobileFailed = BinaryScalaCodec(DoBindMobileFailed)
  lazy val _cDoBindMobileSucceeded = BinaryScalaCodec(DoBindMobileSucceeded)
  ...
  lazy val _cDoDeleteBankCard = BinaryScalaCodec(DoDeleteBankCard)
  ...
  lazy val _cDoVerifyRealName = BinaryScalaCodec(DoVerifyRealName)
  ...
  lazy val _cQueryAllDetailReserve = BinaryScalaCodec(QueryAllDetailReserve)
  lazy val _cQueryAllDetailReserveResult = BinaryScalaCodec(QueryAllDetailReserveResult)
  lazy val _cQueryApiSecretByToken = BinaryScalaCodec(QueryApiSecretByToken)
  lazy val _cQueryApiSecretByTokenResult = BinaryScalaCodec(QueryApiSecretByTokenResult)
  ...
  lazy val _cVerifyRealNameFailed = BinaryScalaCodec(VerifyRealNameFailed)
  lazy val _cVerifyRealNameSucceeded = BinaryScalaCodec(VerifyRealNameSucceeded)
